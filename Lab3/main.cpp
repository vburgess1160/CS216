 ...
 ******PLEASE NOTE THAT THIS FILE IS NOT COMPLETE!******
 */
...
int main(int argc, char** argv)
{
    ...
    if (argc == 1)
    {
	    ...
	    cout << "It has been reversed using a loop: " << to_rev.rev() << endl;
	    cout << "It has been reversed by recursion: " << to_rev.rev_recursive() << endl;
	    cout << "It has been reversed using a stack: " << to_rev.rev_stack() << endl;
    ...
    else 
    {
        ...
        while (getline(inFile, original))
        {
            ...
            cout << "Reverse using a loop --> " << to_rev.rev() << endl;
